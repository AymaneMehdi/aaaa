...
const DefaultHeader = () => {
  ...
  return (
    <div className="bg-white fixed top-0 left-0 right-0 z-10">
      ...
      <header className="relative" style={{ backgroundColor: "#0FB9B6" }}>
        <div className="hid flex items-center justify-between bg-white px-4 py-2 sm:px-6 lg:px-8">
          ...
          <div className=" sm:flex items-center justify-center ml-2 pr-12">
            ...
            <p className="text-black font-semibold  md:text-sm lg:text-xl">
              Envoyez-nous un mail sur: feizhoucom@outlook.fr
            </p>
          </div>
        </div>
            ...
            <div className="flex h-16 items-center">
              ...
              <div className="ml-auto flex items-center">
                ...
                <div className="hidden lg:ml-8 lg:flex flex items-center justify-center ">
                  <Link
                    href={DataBtn.button1.link}
                    className="font-semibold rounded-full mr-[40px] bg-white text-black px-4 py-2"
                  >
                    CONTACTEZ-NOUS
                  </Link>
                  <div className="flex items-center justify-center space-x-4">
                    <Link href={Data.links.linkedin} aria-label="linkedin">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="1.5em"
                        height="1.5em"
                    ...
                    <Link href={Data.links.insta} aria-label="instagram">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="1.5em"
                        height="1.5em"
                    ...
                    <Link href={Data.links.fb} aria-label="facebook">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="1.5em"
                        height="1.5em"
