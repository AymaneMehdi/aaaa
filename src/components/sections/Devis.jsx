...
const TeamSection = () => {
  ...
  return (
    <div className="bg flex flex-wrap justify-center p-4">
    
    
    <div className="flex items-center justify-center bg-gradient-to-r from-[#001925] via-[#001925] to-[#001925] w-[492px] h-[855px]">
  ...
  <a href="#" class="social-button instagram">
    ...
    <div className="form-container">
            <div className="form">
                <span className="heading ml-20">Demander votre devis gratuitement</span>
                <input
                autoComplete="off"
                id="nom"
                name="nom"
        ...
        <div className="result">
          {fille && (
            <div className="file-uploaded"><p>{fille}</p></div>
          )}
        </div>
      </div>
    </form>
                <button class="button">
                  <span class="button-content">E N V O Y E R</span>
                </button>
            </div>
        </div>
    </div>
